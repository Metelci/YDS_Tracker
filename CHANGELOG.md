...
### Fixed
- Compose: removed stray literal 'n' from Brush imports in multiple files (SettingsScreens, ProfileTab, LeaderboardRow, FriendsTab)
- TodayScreen: corrected inferredFeaturePastelContainer usage and StudyPlanTopBar params; normalized separators; aligned Empty/Error display

### Build
- Verified build with ./gradlew assembleDebug -x test
