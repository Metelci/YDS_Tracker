...
android {
    ...
    defaultConfig {
        ...
        // Certificate pins for network security
        buildConfigField("String", "OSYM_HOST", "\"ais.osym.gov.tr\"")
        buildConfigField("String", "OSYM_PRIMARY_PIN", "\"sha256/4a6cPehI7JG923Nwvzn0EoBtcGGqs3oQmWKWSF+gKD4=\"")
        buildConfigField("String", "OSYM_BACKUP_PIN", "\"sha256/Y9mvm0exBkEOvvaZgNEqy1wx1LXiOgtwT0M8LfKOtmI=\"")
    }
